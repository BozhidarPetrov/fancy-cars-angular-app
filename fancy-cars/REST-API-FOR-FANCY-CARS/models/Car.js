...
const carSchema = new Schema({
  ...
  fuel: { type: String, required: [true, 'Fuel is required!'], minlength: [3, 'Fuel must be at least 3 characters long!'] },
  color: { type: String, required: [true, 'Color is required!'], minlength: [3, 'Color must be at least 3 characters long!'] },
